const piecePaths = [
  "pieces_png/pawn-w.svg",
  "pieces_png/pawn-b.svg",
  "pieces_png/rook-w.svg",
  "pieces_png/rook-b.svg",
  "pieces_png/knight-w.svg",
  "pieces_png/knight-b.svg",
  "pieces_png/bishop-w.svg",
  "pieces_png/bishop-b.svg",
  "pieces_png/queen-w.svg",
  "pieces_png/queen-b.svg",
  "pieces_png/king-w.svg",
  "pieces_png/king-b.svg"
];
...
function preloadAllImages(callback) {
  ...
  piecePaths.forEach((src) => {
    const img = new Image();
    img.onload = () => {
      loaded++;
      if (loaded + errored === piecePaths.length) callback();
    };
    img.onerror = () => {
...
function setChessPattern(){
    ...
    let second_clr = "";
    if (theme_on){
      first_clr = "theme1/light_background_block.png";
      second_clr = "theme1/dark_background_block.png";
